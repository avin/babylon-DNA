...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModelsRenderer = __webpack_require__(1);

	var _ModelsRenderer2 = _interopRequireDefault(_ModelsRenderer);

	window.app = {};
	var app = window.app;

	// Init
	app.renderer = new _ModelsRenderer2["default"]();

	app.renderer.initialize(document.getElementById("canvas"), function () {
	    app.renderer.loadScene(function () {
	        app.renderer.run();
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BallLine = __webpack_require__(5);

	var _BallLine2 = _interopRequireDefault(_BallLine);
	...
	var _default = (function () {
	    ...
	    _createClass(_default, [{
	        key: 'initialize',
	        value: function initialize(container, onInit) {
	            var _this = this;
	        ...
	        value: function loadScene(cb) {
	            ...
	            var redBall = BABYLON.Mesh.CreateSphere("mainBall", 5, 1, this.scene, false);
	            ...
	            //Black ball
	            var blackBall = BABYLON.Mesh.CreateSphere('blackBall', 5, 1, this.scene, false);
	            ...
	            //Medium ball
	            var mediumBall = BABYLON.Mesh.CreateSphere('mediumBall', 5, 1, this.scene, false);
	            ...
	            //Light ball
	            var lightBall = BABYLON.Mesh.CreateSphere('lightBall', 5, 1, this.scene, false);
	            ...
	            var lineBalls = { blackBall: blackBall, mediumBall: mediumBall, lightBall: lightBall };

	            var ball = undefined;

	            var _loop = function (i) {
	                var parentMesh = new BABYLON.AbstractMesh('part', _this2.scene);

	                //Draw 2 red balls

	                ball = new _Ball2['default'](_this2, new BABYLON.Vector3(-8, 0, 0), redBall);
	                _lodash2['default'].each(ball.balls, function (ball) {
	                ...
	                var ballLine = new _BallLine2['default'](_this2, [-7, 7], lineBalls);
	                _this2.ballLines.push(ballLine);
	                _lodash2['default'].each(ballLine.balls, function (ball) {
	                    ball.parent = parentMesh;
	                });
	                _lodash2['default'].each(ballLine.randomBalls, function (ball) {
	                    ball.parent = parentMesh;
	                });
	            ...
	            this.scene.beforeRender = function () {
	                var delta = _this2.engine.getDeltaTime() / 1000.0;
	                _this2.time += delta;

	                _this2.update(delta, _this2.time);
	            };
	        ...
	        value: function update(delta, time) {
	            ...
	            _lodash2['default'].each(this.ballLines, function (ballLine) {
	                ballLine.update(delta, time);
	            });

	            _lodash2['default'].each(this.balls, function (ball) {
	        ...
	        value: function updateCameraPosition(delta, time) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _default = (function () {
	    function _default(renderer, coordinate, sourceBall) {
	        _classCallCheck(this, _default);
	    ...
	    _createClass(_default, [{
	        ...
	        value: function init() {
	            ...
	            for (var i = 0; i < 10; i++) {
	                var ball = this.mainBall.createInstance('ball_' + i);
	                ball.position = new BABYLON.Vector3(this.coordinate.x, this.coordinate.y, this.coordinate.z);

	                var p = BABYLON.Matrix.Translation((_lodash2['default'].random(4) - 2) / 5, (_lodash2['default'].random(4) - 2) / 5, (_lodash2['default'].random(4) - 2) / 5);
	                ball.setPivotMatrix(p);

	                var scaleSize = (_lodash2['default'].random(3) + 5) / 5;
	                ball.scaling = new BABYLON.Vector3(scaleSize, scaleSize, scaleSize);
	                ball.randomnes = (_lodash2['default'].random(10) + 5) / 10;
	                ball.speed = _lodash2['default'].random(5) + 5;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _default = (function () {
	    function _default(renderer, fromTo, mainBalls) {
	        _classCallCheck(this, _default);
	    ...
	    _createClass(_default, [{
	        ...
	        value: function init() {
	            ...
	            var randomRemotenessZ = undefined;
	            var randomRemotenessY = undefined;
	            while (x <= this.to) {

	                mesh = _lodash2["default"].sample(this.mainBalls);
	                ball = mesh.createInstance("ball_" + index);
	                ball.position.x = x;
	                scaleSize = (3 + _lodash2["default"].random(3)) / 10;
	                ...
	                if (_lodash2["default"].random(100) > 0) {
	                    randomRemotenessZ = (-5 + _lodash2["default"].random(10)) / 7;
	                    randomRemotenessY = (-5 + _lodash2["default"].random(10)) / 7;
	                    scaleSize = (3 + _lodash2["default"].random(3)) / 10;

	                    mesh = _lodash2["default"].sample(this.mainBalls);
	                    ball = mesh.createInstance("ball" + index);
	                    //ball = BABYLON.Mesh.CreateSphere('mediumBall', 10, this.renderer.scene, false);
	                    ball.position.x = x + (-1 + _lodash2["default"].random(2)) / 10;
	                    ...
	                    ball.speed = _lodash2["default"].random(1, 10) / 10;
	        ...
	        value: function update(delta, time) {
	            ...
	            _lodash2["default"].each(this.randomBalls, function (randomBall) {
